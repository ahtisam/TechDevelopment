<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu.ascx.cs" Inherits="TrendITech.UI.usercontrols.curd.Menu" %>
        ...
        <asp:panel id="pnlCUD" runat="server" cssclass="clearfix">
            <div class="clearfix">
                <p class="formControl clearfix inputText">
                    <label for="ddlMenuType">
                        <span class="required">*</span> Menu Type
                    </label>
                ...
                <p class="formControl clearfix inputText">
                    <label for="ddlParent">
                        <span class="required">*</span> Parent Item
                    </label>
            ...
            <asp:repeater id="repItemCollection" runat="server">
                <itemtemplate>  
                    <tr class="even">  
                            ...
                            <td>
                                <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ParentID") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "menuType.Name") %>'></asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Url") %>'></asp:Label>
                            </td>
                            <td>
